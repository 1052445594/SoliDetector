...
contract SolidityVisibility2 {
   function SolidityVisibility2(address _server, address _guardian) public{
       }
   function SolidityVisibility2(address _server, address _guardian) private{
       }
   function SolidityVisibility2(address _server, address _guardian) external{
          }
