...
contract EthTxOrderDependenceMinimal {
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
        ...
        balances[msg.sender] -= value; //FP-Integer Overflow and Underflow
        balances[to] += value; //FP-Integer Overflow and Underflow
		
		
balances111[to] += value; //FP-Integer Overflow and Underflow
