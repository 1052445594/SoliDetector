...
function bug_tmstmp8 () public payable {
	...
	require(msg.value == 10 ether); // must send 10 ether to play
        require(now != pastBlockTime_tmstmp8); // only 1 transaction per block   //bug //Dependency_of_timestamp bug
...
function bug_tmstmp40 () public payable {
	...
	require(msg.value == 10 ether); // must send 10 ether to play
        require(now != pastBlockTime_tmstmp40); // only 1 transaction per block   //bug //Dependency_of_timestamp bug
...
function bug_tmstmp4 () public payable {
	...
	require(msg.value == 10 ether); // must send 10 ether to play
        require(now != pastBlockTime_tmstmp4); // only 1 transaction per block   //bug //Dependency_of_timestamp bug
